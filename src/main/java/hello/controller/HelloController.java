...
public class HelloController {
    ...
    private static final String MAKE_DISTINCT_AND_SORT_CHARACTERS_TEMPLATE =
            "-------------Get all ID characters, select distict and sort with ID=   ";
    private static final String SPLIT_ALL_ID_TEMPLATE = """
            -------------Split All Id With Colon,\
            Select ID With "Java" Keyword,\
             Then Sort Then Join \
            """;
    private static final String FIND_ID_HAVING_CHARACTER_TEMPLATE =
            "-------------Return All ID having character 'g' in it:  ";
    private static final String FIND_ALL_FILES_IN_PATH_AND_SORT_TEMPLATE =
            "---------Find all files in path and sort:    ";
    private static final String FIND_PARTICULAR_FILE_IN_PATH_AND_SORT_TEMPLATE =
            "----------Find File in present directory which strats with \"grad\",provided maximum depth=25 and sort : ";
    private static final String FIND_PARTICULAR_FILE_IN_PATH_AND_SORT_WITH_WALK_FUNCTION_TEMPLATE =
            "----------Find File in present directory which strats with \"grad\",provided maximum depth=25 and sort :  with walk function";
    private static final String READ_FILE_WITH_STREAM_FUNCTION_TEMPLATE =
            "---------Read \"temp.txt\" file with stream functions, having \"print\" witin it:  ";
    ...
    public String showStringOperation() {
        ...
        return JOIN_TEMPLATE + join
                ...
                + SPLIT_ALL_ID_TEMPLATE + splitAllIdWithColonSelectIDWithJavaKeywordThenSortThenJoin
    ...
    public String showFileOperation() {
        ...
        return FIND_ALL_FILES_IN_PATH_AND_SORT_TEMPLATE + findAllFilesInPathAndSort
